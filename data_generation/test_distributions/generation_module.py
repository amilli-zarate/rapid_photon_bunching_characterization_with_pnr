...
def obtener_Pn_incompleta(variable_aleatoria, realizaciones, n_limite=10):
	"""
	...
	for n in range(n_limite+1):
		P_incompleta[int(n)] = ocurrencias.count(n)/realizaciones
...
X_realizaciones = stats.loguniform(5e3,1e5)